    ...
    const docDefinition = {
      content: [
        ...
        },
        {
          columns: [
            {
              image: this.hvacPics[0].data,
              width: 150,
              height: 150,
            },
            {
              image: this.hvacPics[1].data,
              width: 150,
              height: 150,
            },
          ],
